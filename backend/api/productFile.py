...
@router.get("/get_all_products", response_model=list[ProductInCatalogInfo], status_code=status.HTTP_200_OK)
async def get_all_products(request: Request):
    return await ProductService.get_all_products(request)
