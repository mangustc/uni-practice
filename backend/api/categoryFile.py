...
@router.post("/AddCategoryRoot", response_model=CategoryResponse, status_code=status.HTTP_201_CREATED)
...
@router.get("/GetCategoryRoots", response_model=list[CategoryResponse], status_code=status.HTTP_200_OK)
